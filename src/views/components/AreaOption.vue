<template>
  <div>
    ...
    <el-dialog :visible.sync="visible" append-to-body title="选择片区">
      <el-table :data="items" border stripe highlight-current-row @current-change="handleCurrentChange">
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(currentRow) {
      ...
      this.areaName = currentRow.name
      this.radio = this.items.findIndex(item => item.id === this.areaId)
    }
  }
}
</script>
